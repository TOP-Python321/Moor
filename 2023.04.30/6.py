...
# Вот не поверите, но это был самый первый вариант решения, когда обсуждали задачу) Отказались от него потому, что показалось решение слишком легким)
# правда множество было чуть больше {'01', '10', 'b1', 'b0', '0b', '1', '11', '0'}
answer = 'нет'
