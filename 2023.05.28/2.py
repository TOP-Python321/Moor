...
# КОММЕНТАРИЙ: по импортам претензий нет, но работу со строками определённо надо прокачивать — вдруг шаблонизатор какой-нибудь писать придётся, что делать будете?
